<div>
    ...
    <?php else: ?>
        <div class="well text-center">
            Please <?= $this->Html->link('Login', ['controller' => 'Users', 'action' => 'login','prefix'=>false,'plugin'=>false],['escape'=>false]) ?> or <?= $this->Html->link('Register', ['controller' => 'Users', 'action' => 'register','prefix'=>false,'plugin'=>false],['escape'=>false]) ?> to comment.
        </div>
    <?php endif; ?>
</div>